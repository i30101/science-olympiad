...
let ciphers = [
    ...
    ["Baconian",     175,    "Decode this phrase that was encoded using the Baconian cipher.",                                                       "DILAYLPDAYILAPDYIPLDIAPDIPYLDIPDAYIPDIPDILAPDIPDYLIPAYDIPDIPLDIAPDIYLAP DYIPLDIPDIAPDIPYLDIPDAYIPLDIPDAYIPLDIAPDIYLAPDYIPLDAIPDYLIAPYLDAIPDYLAIPDY"],
    ...
    ["Caesar",       75,     "Encode this quote using the Caesar cipher with a shift of 1776.",                                                       "BPM CVQBML ABIBMA KIXQBWT JCQTLQVO EIA MFXIVLML JMKICAM BPMZM EMZM BWW UIVG ABIBMA."],
